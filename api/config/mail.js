...
exports.sendMail2 = (toEmail, subject, html) => {
    const fromEmail = "jihyeon <ijihyeon0924@gmail.com>";
...
exports.sendAttachedImgMail = (toEmail, subject, html, filename, cid) => {
    const fromEmail = "모티프 고객센터 <support@motifme.io>";
	...
	html += "<br><br><br><br><br>--"
	     ...
	     + "<br>"
		 + '<div style="font-size:10px;">'
		 + '웹사이트: <a href="http://www.motifme.io"> www.motifme.io </a> | 대표메일: <a href="mailto:﻿"support@motifme.io"> support@motifme.io </a> <br>'
		 + '(우) 41585 대구광역시 북구 호암로 51, 2층(메이커스페이스동, 침산동)';
    ...
    var mailOptions = {
		...
		attachments: [{
			filename: filename,
			path: path.join('..', 'motif-server', 'views', 'files', filename),
			cid: cid
		}]
    };

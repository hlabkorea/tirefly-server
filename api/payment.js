...
function saveOrder(paidId, paymentData) {
    ...
    // 결제 정보 저장
    var paymentInsertSql = "insert payment(userUID, amount, addr1, addr2, requireMents, applyNum, bankName, buyerAddr, buyerEmail, buyerName, buyerPostcode, buyerTel, cardName, " +
        "cardNumber, cardQuota, currency, customerUid, impUid, " +
...
api.post("/inapp",
    ...
    async (req, res) => {
        ...
        if (errors.isEmpty()) {
            ...
            var excludeOldTransactions = true; // 최신 갱신 트랜잭션만 포함
